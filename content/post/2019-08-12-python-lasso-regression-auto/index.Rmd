...
We use scikit learn to fit a Lasso regression [(see documentation)](http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.Lasso.html) and follow a number of steps (note that scikit-learn uses $\alpha$ instead of $\lambda$ in their notation):
