...
```{r out.width="50%", echo=FALSE, fig.align='center', fig.cap='Market basket example (Ng & Soo, 2017)'}
...
For a detailed description, review the [vignette of the package](https://cran.r-project.org/web/packages/arulesViz/arulesViz.pdf):
